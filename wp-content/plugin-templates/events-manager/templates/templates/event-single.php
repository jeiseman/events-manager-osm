...
<div class="<?php em_template_classes('view-container'); ?>" id="em-view-<?php echo $id; ?>" data-view="event">
    ...
    <div class="em-event-navigation">
        <?php
        // Option 1: Display both links with default labels and separator
        my_em_get_previous_next_event_links('Previous', 'Next, ' --- ');

        // Option 2: Display individual links if you want more control over their placement
        // my_em_get_previous_event_link('<< Previous');
        // echo '<span class="separator"> | </span>';
        // my_em_get_next_event_link('Next >>');

        // Option 3: Customize labels and separator
        // my_em_get_previous_next_event_links( 'Older Event', 'Newer Event', ' --- ' );
        ?>
    </div>
</div>
